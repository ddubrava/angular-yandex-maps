...
export class YaPlacemarkDirective implements OnInit, OnChanges, OnDestroy {
   ...
   * {@link https://tech.yandex.com/maps/jsapi/doc/2.1/ref/reference/Placemark-docpage/#Placemarkparam-properties}
   */
  @Input() properties: object | ymaps.IDataManager;

  /**
   * Options for the placemark.
   * {@link https://tech.yandex.com/maps/jsapi/doc/2.1/ref/reference/Placemark-docpage/#Placemarkparam-options}
   */
   ...
   * Closing the balloon.
   */
  @Output() balloonclose: Observable<YaEvent<ymaps.Placemark>> = this._eventManager.getLazyEmitter(
    'balloonclose',
  );
   ...
   */
  @Output() balloonopen: Observable<YaEvent<ymaps.Placemark>> = this._eventManager.getLazyEmitter(
    'balloonopen',
  );
   ...
   */
  @Output() beforedrag: Observable<YaEvent<ymaps.Placemark>> = this._eventManager.getLazyEmitter(
    'beforedrag',
  );
  ...
  @Output() beforedragstart: Observable<
    YaEvent<ymaps.Placemark>
  > = this._eventManager.getLazyEmitter('beforedragstart');

  /**
   * Single left-click on the object.
   */
  @Output() yaclick: Observable<YaEvent<ymaps.Placemark>> = this._eventManager.getLazyEmitter(
    'click',
  );
   ...
   */
  @Output() yacontextmenu: Observable<YaEvent<ymaps.Placemark>> = this._eventManager.getLazyEmitter(
    'contextmenu',
  );
   ...
   */
  @Output() yadbclick: Observable<YaEvent<ymaps.Placemark>> = this._eventManager.getLazyEmitter(
    'dbclick',
  );
   ...
   */
  @Output() yadrag: Observable<YaEvent<ymaps.Placemark>> = this._eventManager.getLazyEmitter(
    'drag',
  );
   ...
   */
  @Output() yadragend: Observable<YaEvent<ymaps.Placemark>> = this._eventManager.getLazyEmitter(
    'dragend',
  );
   ...
   */
  @Output() yadragstart: Observable<YaEvent<ymaps.Placemark>> = this._eventManager.getLazyEmitter(
    'dragstart',
  );
   ...
   * Closing the hint.
   */
  @Output() hintclose: Observable<YaEvent<ymaps.Placemark>> = this._eventManager.getLazyEmitter(
    'hintclose',
  );
   ...
   */
  @Output() hintopen: Observable<YaEvent<ymaps.Placemark>> = this._eventManager.getLazyEmitter(
    'hintopen',
  );
   ...
   */
  @Output() mapchange: Observable<YaEvent<ymaps.Placemark>> = this._eventManager.getLazyEmitter(
    'mapchange',
  );
   ...
   */
  @Output() yamousedown: Observable<YaEvent<ymaps.Placemark>> = this._eventManager.getLazyEmitter(
    'mousedown',
  );
   ...
   */
  @Output() yamouseenter: Observable<YaEvent<ymaps.Placemark>> = this._eventManager.getLazyEmitter(
    'mouseenter',
  );
   ...
   */
  @Output() yamouseleave: Observable<YaEvent<ymaps.Placemark>> = this._eventManager.getLazyEmitter(
    'mouseleave',
  );
   ...
   */
  @Output() yamousemove: Observable<YaEvent<ymaps.Placemark>> = this._eventManager.getLazyEmitter(
    'mousemove',
  );
   ...
   */
  @Output() yamouseup: Observable<YaEvent<ymaps.Placemark>> = this._eventManager.getLazyEmitter(
    'mouseup',
  );
   ...
   * End of multitouch.
   */
  @Output() multitouchend: Observable<YaEvent<ymaps.Placemark>> = this._eventManager.getLazyEmitter(
    'multitouchend',
  );
   ...
   */
  @Output() optionschange: Observable<YaEvent<ymaps.Placemark>> = this._eventManager.getLazyEmitter(
    'optionschange',
  );
   ...
   */
  @Output() overlaychange: Observable<YaEvent<ymaps.Placemark>> = this._eventManager.getLazyEmitter(
    'overlaychange',
  );
   ...
   */
  @Output() parentchange: Observable<YaEvent<ymaps.Placemark>> = this._eventManager.getLazyEmitter(
    'parentchange',
  );
   ...
   */
  @Output() yawheel: Observable<YaEvent<ymaps.Placemark>> = this._eventManager.getLazyEmitter(
    'wheel',
  );
