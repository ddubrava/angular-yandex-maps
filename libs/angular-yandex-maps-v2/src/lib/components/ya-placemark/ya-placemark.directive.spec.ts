...
describe('YaPlacemarkDirective', () => {
  ...
  it('should set geometry', () => {
    ...
    mockComponent.geometry = geometry;
    fixture.detectChanges();
  ...
  it('should set placemark properties and options', () => {
    ...
    mockComponent.properties = properties;
  ...
  it('should be able to add an event listener after init', () => {
    ...
    const subscription = mockComponent.placemark.editorstatechange.subscribe();
    fixture.detectChanges();
