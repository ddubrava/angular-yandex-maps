...
export class YaMultirouteDirective implements OnInit, OnChanges, OnDestroy {
   ...
   * {@link https://yandex.com/dev/jsapi-v2-1/doc/en/v2-1/ref/reference/IMultiRouteReferencePoint.html}
   */
  @Input() referencePoints: ymaps.IMultiRouteReferencePoint[] = [];

  /**
   * The data model of a multi-route, or the model description object.
   * {@link https://yandex.com/dev/jsapi-v2-1/doc/en/v2-1/ref/reference/multiRouter.MultiRoute.html#multiRouter.MultiRoute__param-model}
   */
  @Input() model?:
  ...
  /**
   * Multi-route options.
   * {@link https://yandex.com/dev/jsapi-v2-1/doc/en/v2-1/ref/reference/multiRouter.MultiRoute.html#multiRouter.MultiRoute__param-options}
   */
   ...
   * {@link https://yandex.com/dev/jsapi-v2-1/doc/en/v2-1/ref/reference/multiRouter.MultiRoute.html#event_detail__event-activeroutechange}
   */
  ...
  /**
   * Closing the balloon.
   * {@link https://yandex.com/dev/jsapi-v2-1/doc/en/v2-1/ref/reference/multiRouter.MultiRoute.html#event_detail__event-balloonclose}
   */
  ...
  /**
   * Opening the balloon.
   * {@link https://yandex.com/dev/jsapi-v2-1/doc/en/v2-1/ref/reference/multiRouter.MultiRoute.html#event_detail__event-balloonopen}
   */
   ...
   * {@link https://yandex.com/dev/jsapi-v2-1/doc/en/v2-1/ref/reference/multiRouter.MultiRoute.html#event_detail__event-boundsautoapply}
   */
   ...
   * {@link https://yandex.com/dev/jsapi-v2-1/doc/en/v2-1/ref/reference/multiRouter.MultiRoute.html#event_detail__event-boundschange}
   */
   ...
   * {@link https://yandex.com/dev/jsapi-v2-1/doc/en/v2-1/ref/reference/multiRouter.MultiRoute.html#event_detail__event-pixelboundschange}
   */
   ...
   * {@link https://yandex.com/dev/jsapi-v2-1/doc/en/v2-1/ref/reference/multiRouter.MultiRoute.html#event_detail__event-update}
   */
