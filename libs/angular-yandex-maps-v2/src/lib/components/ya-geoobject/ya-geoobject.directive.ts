...
export class YaGeoObjectDirective implements OnInit, OnChanges, OnDestroy {
   ...
   * {@link https://yandex.com/dev/jsapi-v2-1/doc/en/v2-1/ref/reference/GeoObject.html#GeoObject__param-feature}
   */
  @Input() feature?: ymaps.IGeoObjectFeature;

  /**
   * Geo object options.
   * {@link https://yandex.com/dev/jsapi-v2-1/doc/en/v2-1/ref/reference/GeoObject.html#GeoObject__param-options}
   */
