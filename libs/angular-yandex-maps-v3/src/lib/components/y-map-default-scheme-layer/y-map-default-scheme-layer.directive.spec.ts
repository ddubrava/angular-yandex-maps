...
import { YMapDefaultSchemeLayer, YMapDefaultSchemeLayerProps } from '@yandex/ymaps3-types';
...
@Component({
  ...
  template:
    '<y-map-default-scheme-layer [props]="props" [children]="children" [options]="options" />',
})
class MockHostComponent {
  ...
  children?: ConstructorParameters<typeof YMapDefaultSchemeLayer>[1];

  options: ConstructorParameters<typeof YMapDefaultSchemeLayer>[2];
}
...
describe('YMapDefaultSchemeLayerDirective', () => {
  ...
  it('should pass inputs to constructor', () => {
    ...
    const options: ConstructorParameters<typeof YMapDefaultSchemeLayer>[2] = {
      container: false,
    };
  ...
  it('should pass children to constructor if defined', () => {
    ...
    const children = [{}] as ConstructorParameters<typeof YMapDefaultSchemeLayer>[1];
